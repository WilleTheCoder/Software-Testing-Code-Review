...
class NextDateTestPC {
	...
	@Test
	public void TCP1() {
		assertEquals("invalid Input Date", nd.run(1, 0, 2001));
	}
	
	@Test
	public void TCP2() {
		assertEquals("invalid Input Date", nd.run(0, 1, 2001));
	}
	
	@Test
	public void TCP3() {
		assertEquals("invalid Input Date", nd.run(13, 1, 2001));
	}
	
	@Test
	public void TCP4() {
		assertEquals("invalid Input Date", nd.run(10, 1, 1800));
	}
	
	@Test
	public void TCP5() {
		assertEquals("invalid Input Date", nd.run(10, 1, 2022));
	}
